...
module.exports = {
  ...
  resolve: {
    ...
    alias: {
      ...
      morel: 'morel/dist/morel',
      touchswipe: 'jquery-touchswipe/jquery.touchSwipe.min',
      leaflet: 'leaflet/dist/leaflet',
      OSOpenSpace: 'os-leaflet/OSOpenSpace',
      'Leaflet.GridRef': 'leaflet.gridref/L.GridRef',
      proj4: 'proj4/dist/proj4',
      LatLon: 'geodesy/latlon-ellipsoidal',
      OsGridRef: 'geodesy/osgridref',
      'latlon-ellipsoidal': 'geodesy/latlon-ellipsoidal',
