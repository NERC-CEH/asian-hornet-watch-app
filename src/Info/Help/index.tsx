      ...
      <div className="rounded-list">
        <Collapse title="How to make a new record">
          <div className="collapse-content-wrapper">
            <p>
              Please press the 'Record' button in the home page. This will bring
              you to the record form page. After selecting the species, fill in
        ...
        <Collapse title="Sync. with iRecord">
          <div className="collapse-content-wrapper">
            <p>
              ...
              reached the database the record becomes unavailable for new edits.
              To further edit it please use the{' '}
              <a href="https://irecord.org.uk">iRecord Website</a>.
            </p>

            <p>
              All records submitted via the Hornet app are initially treated as
              confidential and will not appear in other iRecord reports unless
              the confidential status is retracted.
            </p>

            <p>
              <b>Note:</b> you have to be signed in to your iRecord account and
